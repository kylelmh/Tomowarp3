...
/*-----------------------------------------------
              @(target):= _pixel_search.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__pixel_search

#else
#  define SWIG_init    init_pixel_search

#endif
#define SWIG_name    "_pixel_search"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_pixel_search(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "pixel_search", 3, 3, swig_obj)) SWIG_fail;
  {
    npy_intp size[3] = {
      -1, -1, -1 
    };
    array1 = obj_to_array_contiguous_force_conversion(swig_obj[0], NPY_FLOAT,
      &is_new_object1);
  ...
  }
  {
    ...
    array5 = obj_to_array_contiguous_force_conversion(swig_obj[1], NPY_FLOAT,
      &is_new_object5);
  ...
  }
  {
    ...
    arg9 = (int) PyInt_AsLong(swig_obj[2]);
    dims[0] = (npy_intp) arg9;
    array9 = PyArray_SimpleNew(1, dims, NPY_FLOAT);
    if (!array9) SWIG_fail;
    arg10 = (float*) array_data(array9);
  }
  pixel_search(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "pixel_search", _wrap_pixel_search, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
